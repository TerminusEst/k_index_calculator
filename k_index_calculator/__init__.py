...
a = BxByBzPlots(minute_time, minute_bx, minute_by, minute_bz, 1, titlez = "FUCK", stamp = "Yo shit up")

a.set_size_inches(9, 8.5)
a.savefig("wtf.png")
...
"""
	...
	plt.locator_params(axis='y', nbins=6)
	plt.ylabel("Bx (nT)", fontsize = 14)
	plt.title("Birr 3-Day Bx, By, Bz", fontsize = 16)
	...
	plt.figtext(0.55, 0.02, timestamp_string, fontsize = 11, style='italic')
	plt.figtext(0.02, 0.02, "TCD/DIAS", fontsize = 11, style = 'italic')
	
	fig1.set_size_inches(9, 8.5)
	fig1.savefig("C:\Inetpub\wwwroot\data\\realtime\magnetometer\\bxbybz.png")
